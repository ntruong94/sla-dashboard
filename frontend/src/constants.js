...
export const TOOLTIPS = {
  kpi: {
    ...
    totalOverdue: 'Count of tasks that have exceeded their SLA target on the reporting date.\n\nRules:\n- Open tasks: overdue when elapsed time > configured target, or GETDATE() > SLAAdjustedDate.\n- Closed tasks: overdue when TotalHoursOnTask \u2260 0 AND TotalHoursOnTask > SLAInHours, or DateCompleted > SLAAdjustedDate.\n\nIncludes: Open (In Progress, On Hold, On Queue, Not Queued) + Closed.\n\nExcluded: Cancelled. Closed tasks where TotalHoursOnTask = 0.\n\nDate basis: Date Created.\n\nTarget is configurable per team In Settings.',
  },
  team: {
    ...
    overdue: 'Count of tasks in this team that have exceeded their SLA target.\n\nRules:\n- Open tasks: overdue when elapsed time > configured target, or GETDATE() > SLAAdjustedDate.\n- Closed tasks: overdue when TotalHoursOnTask \u2260 0 AND TotalHoursOnTask > SLAInHours, or DateCompleted > SLAAdjustedDate.\n\nIncludes: Open (In Progress, On Hold, On Queue, Not Queued) + Closed tasks for this team.\n\nExcluded: Cancelled. Closed tasks where TotalHoursOnTask = 0.\n\nDate basis: Date Created.\n\nTarget is configurable per team In Settings.',
