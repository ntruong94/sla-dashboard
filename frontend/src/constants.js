...
export const TOOLTIPS = {
  kpi: {
    ...
    avgTat:       'Average TAT of ACTIVE tasks \n\nRules:\n- avg TAT = avg TotalHoursOnTask_BH \n\nIncludes: Active\n\nExcluded: Tasks where TotalHoursOnTask_BH is null are excluded from the average\n\nDate basis: Date Created.',
    totalOverdue: 'Count of active tasks that have exceeded their SLA target.\n\nRules:\n- Overdue when TotalHoursOnTask_BH > SLAInHours\n- Overdue when  Current time > SLAAdjustedDate \n- Overdue when TotalHoursOnTask_BH> SLA target hours in Setting tab\n\nIncludes: Active\n\nExcluded: Cancelled; Completed tasks; Tasks where TotalHoursOnTask_BH is null or = 0\n\nDate basis: Date Created.\n\nTarget is configurable per team In Settings.',
  },
  team: {
  ...
  modal: {
    ...
    avgTat:  'Average TAT of ACTIVE tasks \n\nRules:\n- avg TAT = avg TotalHoursOnTask_BH\n\nIncludes: Completed\n\nExcluded: Tasks where TotalHoursOnTask_BH is null are excluded from the average\n\nDate basis: Date Created.',
    avgTatCompleted: 'Average TAT across completed tasks \n\nRules:\n- avg TAT = avg TotalHoursOnTask_BH when not null\n- DateDiff (DateCreated, DateCompleted) in hours when TotalHoursOnTask_BH is null and SLAAdjustedDate is set\n\nIncludes: Completed\n\nExcluded: Tasks where TotalHoursOnTask_BH is null and SLAAdjustedDate is null\n\nDate basis: Date Created.',
    overdue: 'Count of active tasks that have exceeded their SLA target.\n\nRules:\n- Overdue when TotalHoursOnTask_BH > SLAInHours\n- Overdue when  Current time > SLAAdjustedDate \n- Overdue when TotalHoursOnTask_BH> SLA target hours in Setting tab\n\nIncludes: Active\n\nExcluded: Cancelled; Completed tasks; Tasks where TotalHoursOnTask_BH is null or = 0\n\nDate basis: Date Created.\n\nTarget is configurable per team In Settings.',
    overdueCompleted: 'Count of completed tasks that exceeded their SLA target.\n\nRules:\n- Overdue when TotalHoursOnTask_BH > SLAInHours\n- Overdue when DateCompleted > SLAAdjustedDate\n\nIncludes: Completed\n\nExcluded: Cancelled; Active tasks; Tasks where TotalHoursOnTask_BH is null or = 0\n\nDate basis: Date Created',
  },
  alerts: {
